<%@ Page Inherits="System.Web.Mvc.ViewPage<AccurateAppend.Websites.Admin.Areas.JobProcessing.Summary.Models.JobsRequest>" Language="C#" MasterPageFile="~/Views/Shared/bootstrap3.Master" Title="" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="DocumentStart" runat="server">
  ...
  <script src="<%= Url.Content("~/Areas/JobProcessing/Summary/Scripts/Index.js") %>" type="text/javascript"> </script>
