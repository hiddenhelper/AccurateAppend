...
namespace AccurateAppend.Websites.Admin.Areas.Sales.CreateBill.Data
{
    ...
    /// </summary>
    public class UsageBillFormatterText : TextBillFormatter
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UsageBillFormatterText"/> class.
        /// </summary>
        /// <param name="context">The <see cref="ISessionContext"/> providing data access.</param>
        public UsageBillFormatterText(ISessionContext context)
        {
        ...
        {
            var intro = "Your usage billing has been processed. Your receipt and information regarding your order are detailed below.\r\n";
            return intro;
        }
