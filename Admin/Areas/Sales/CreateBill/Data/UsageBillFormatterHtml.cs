...
{
    /// <summary>
    /// <see cref="BillFormatter"/> used to create usage bills in HTML format.
    /// </summary>
    public class UsageBillFormatterHtml : HtmlBillFormatter
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UsageBillFormatterHtml"/> class.
        /// </summary>
        /// <param name="context">The <see cref="ISessionContext"/> providing data access.</param>
        public UsageBillFormatterHtml(ISessionContext context)
        {
        ...
        {
            return Task.FromResult(bill.Title);
        }

        /// <inheritdoc />
        protected override String CreateContentIntroBlock(Order order)
        {
            return UsageTemplate.ContentIntroBlock;
        }
     ...
     <tr>
      <td height=""1"" bgcolor=""#dddddd"" colspan=""7"" style=""font-size: 1px; line-height: 1px;""></td>
            ...
            sb.AppendLine(String.Format(ReceiptTemplate.ContentLineItem, "[CREDIT FROM SUBSCRIPTION]", String.Empty, String.Empty, order.OrderMinimum.RoundFractionalPennies().ToString("C2", CultureInfoHelper.SystemCulture)));
            return sb.ToString();
        }
