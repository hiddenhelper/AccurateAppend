...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" style="padding: 0 0 20px 20px;">
     <div id="processing">
      We're are currently processing this refund. You can wait or continue using the admin. Navigating away from this window will not affect the refund being completed.
      <br />
