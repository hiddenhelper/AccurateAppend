...
namespace AccurateAppend.Websites.Admin.Areas.Sales.ExpireDeal
{
    /// <summary>
    /// Controller to expire an in billing <see cref="DealBinder"/>
    /// </summary>
    [Authorize()]
    public class ExpireDealController : ActivityLoggingController2
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpireDealController"/> class.
        /// </summary>
        /// <param name="service">The <see cref="DealProcessService"/> api.</param>
        public ExpireDealController(DealProcessService service)
        {
        ...
        public virtual async Task<ActionResult> Index(Int32 dealId, CancellationToken cancellation)
        {
            try
            {
                await this.service.Expire(dealId, cancellation);
