<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/bootstrap3.Master" Inherits="ViewPage<CreateFixedRateModel>" %>
  ...
  <div class="row" style="padding: 0 0 20px 20px;">
    <div class="col-md-4">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">Fixed Rate Subscription Details</div>
        <div class="panel-body">
          <% using (Html.BeginForm("CreateFixedRate", "ContractWizard", FormMethod.Post, new {@class = "form-horizontal"}))
             {
          %>
