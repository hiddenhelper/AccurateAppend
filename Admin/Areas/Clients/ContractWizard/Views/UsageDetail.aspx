<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/bootstrap3.Master" Inherits="ViewPage<CreateUsageModel>" %>
    ...
    <div class="col-md-4">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <% using (Html.BeginForm("CreateUsage", "ContractWizard", FormMethod.Post, new {@class = "form-horizontal"}))
             {
          %>
