...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>The system accepts ".txt", ".csv", ".xls", and ".xlsx" file extensions.</p>
    <p>".xls" and ".xlsx" will be converted to .csv</p>
    <p>".txt" files can be delimited with comma, tab or pipe.</p>
    <div class="alert" style="display: none;">
        ...
        <p style="margin-top: 10px;">
            <button id="skipUpload" class="btn btn-default" style="display: inline;">Build Manifest Only ></button>
        </p>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#files").kendoUpload({
                multiple: false,
                async: {
                        saveUrl: "<%= this.Model.PostbackUri.ToString() %>",
                        autoUpload: true,
            ...
            $("#skipUpload").click(function() {
                history.pushState(null, "UploadFile", "/Batch/UploadFile");
                window.location.replace("/Batch/DynamicAppend?Category=DownloadManifest");
                return false;
            });

            // hide button if a rule is being created
            var category = '<%: ViewData["Category"] %>';
            if (category === "AddAutoRule") $("#skipUpload").hide();
