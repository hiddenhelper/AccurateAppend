...
{
    /// <summary>
    /// Contains the data used by the <see cref="SubscriptionBillingSaga"/> to operate.
    /// </summary>
    [DebuggerDisplay("Subscription: {" + nameof(SubscriptionId) + "}")]
    [Serializable()]
    public class SubscriptionBillingData : ContainSagaData
    {
        /// <summary>
