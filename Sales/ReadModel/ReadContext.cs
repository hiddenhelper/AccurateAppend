...
{
    /// <summary>
    /// A custom <see cref="ReadOnlyContext"/> for managing the sales read-model.
    /// </summary>
    public class ReadContext : ReadOnlyContext, ISessionContext
    {
        ...
        protected override void OnModelCreating(System.Data.Entity.DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new DealViewConfiguration());
            modelBuilder.Configurations.Add(new DealNoteViewConfiguration());
        }
        ...
        /// <summary>
        /// Gets a no tracked queryable for the <see cref="DealView"/> model.
        /// </summary>
        public virtual IQueryable<DealView> Deals => this.SetOf<DealView>().AsNoTracking();

        /// <summary>
        /// Gets a no tracked queryable for the <see cref="DealNoteView"/> model.
        /// </summary>
        public virtual IQueryable<DealNoteView> Audits => this.SetOf<DealNoteView>().AsNoTracking();
