...
function initInputMask() {
	jQuery(".edit-profile-phone").inputmask({
		"mask": "(999) 999-9999",
		clearMaskOnLostFocus: true,
		placeholder: "(xxx) xxx-xxxx"
	});
	jQuery(".edit-profile-password").inputmask({
		"mask": "9999 9999 9999 9999",
		clearMaskOnLostFocus: true,
		placeholder: "**** **** **** ****"
	});
	jQuery(".edit-profile-cvv").inputmask({
		"mask": "999",
		clearMaskOnLostFocus: true,
		placeholder: "***"
	});
...
function initCustomForms() {
  ...
  var kendoGridPager = document.getElementById("k-dropdown");
  jcf.destroyAll(kendoGridPager);
}
...
function initTabRadioActive(){
	jQuery('.nav .nav-link').each(function(){
		var $this = jQuery(this);
		if($this.hasClass('active')){
			$this.find('.jcf-radio').addClass('jcf-checked').removeClass('jcf-unchecked');
		}
	})
	jQuery('.nav').on('click', '.nav-link', function(){
		var $this = jQuery(this);
		jQuery('.jcf-radio').addClass('jcf-unchecked').removeClass('jcf-checked');
		setTimeout(function() {
