...
namespace AccurateAppend.Websites.Clients.Areas.Box.AuthHandler
{
    ...
    /// </summary>
    /// <remarks>
    /// Simple holder type for the integration application settings for Box.com system. Allows the configuration
    /// to use constructor injection of these values in a simple fashion.
    /// </remarks>
    public class BoxConfiguration
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BoxConfiguration"/> class.
        /// </summary>
        /// <param name="clientId">The <see cref="ClientId"/> value.</param>
        /// <param name="secret">The <see cref="Secret"/> key value.</param>
        public BoxConfiguration(String clientId, String secret)
        {
        ...
        /// <summary>
        /// Gets the value used to identify this application runtime instance for oAuth registration with Box.com system.
        /// </summary>
        /// <value>The value used to identify this application runtime instance for oAuth registration with Box.com system.</value>
