...
namespace AccurateAppend.Websites.Clients.Areas.Public.Payment.Models
{
    [Serializable()]
    public class PaymentDetailsModel : IValidatableObject
    {
        ...
        public virtual IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (String.IsNullOrEmpty(this.CardState)) errors.Add(new ValidationResult("Card State is required", new[] { nameof(this.CardState) }));
