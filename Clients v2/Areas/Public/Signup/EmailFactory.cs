...
namespace AccurateAppend.Websites.Clients.Areas.Public.Signup
{
    ...
    {
        public static async Task<Message> SendNewAccountNotifcationToClient(String email, String password, Guid applicationId)
        {
            ...
            using (var body = new TemplateEngine())
            {
                ...
                message.BccTo.Add("jimmy@accurateappend.com");
        ...
        {
            var resource = new FileResource(@"EmailTemplates\Welcome_Public.Html.config");
            return resource;
        }
