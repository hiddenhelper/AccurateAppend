...
namespace AccurateAppend.Websites.Clients.Areas.Order.Analyzers
{
    ...
    /// a street address and either a City and State OR a postal code value.
    /// </summary>
    public class AddressSuitabilityObserver : OperationSuitabilityObserver
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressSuitabilityObserver"/> class.
        /// </summary>
        ...
        public AddressSuitabilityObserver(PublicProduct operation, ColumnMap columnMap) : base(operation.Convert())
        {
