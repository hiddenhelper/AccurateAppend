...
{
    /// <summary>
    /// A custom <see cref="DataContext"/> for managing the clients application read-model.
    /// </summary>
    public class ReadContext : ExtendedDbContext, ISessionContext
    {
        #region Constructors
        ...
        /// Not supported.
        /// </summary>
        public sealed override Int32 SaveChanges()
        {
        ...
        /// Not supported.
        /// </summary>
        public sealed override Task<Int32> SaveChangesAsync(CancellationToken cancellationToken)
        {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new NationBuilderOrderConfiguration());
            modelBuilder.Configurations.Add(new BatchOrderConfiguration());
            modelBuilder.Configurations.Add(new DirectClientOrderConfiguration());
        }
        ...
        public virtual IQueryable<Order> Orders => this.SetOf<Order>().AsNoTracking();
